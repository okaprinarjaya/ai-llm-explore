...
db = "/mnt/c/Users/okapr/OneDrive/Documents/db-sqlite/travel2.sqlite"
...
@tool
def cancel_ticket(ticket_no: str, *, config: RunnableConfig):
    ...
    if not existing_ticket:
        ...
        return f"Current signed-in passenger with ID {passenger_id} not the owner of the ticket {ticket_no}"
